        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="hover:text-primary transition-colors text-slate-400" aria-label="Facebook">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1V12h3v3h-3v6.8c4.56-.93 8-4.96 8-9.8z"/>
                </svg>
              </a>
              <a href="#" className="hover:text-primary transition-colors text-slate-400" aria-label="Instagram">
              ...
              <a href="#" className="hover:text-primary transition-colors text-slate-400" aria-label="Twitter">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold uppercase text-white tracking-wider mb-4">Shop Categories</h3>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-sm font-semibold uppercase text-white tracking-wider mb-4">Links</h3>
            <ul className="space-y-2 text-sm text-slate-400">
              <li>
          ...
          {/* Contact Details */}
          <div>
            <h3 className="text-sm font-semibold uppercase text-white tracking-wider mb-4">Contact Us</h3>
